...
ActiveRecord::Schema.define(version: 2019_10_24_233435) do
  ...
  create_table "graduations", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["doctor_id"], name: "index_graduations_on_doctor_id"
    t.index ["specialty_id"], name: "index_graduations_on_specialty_id"
  end
  ...
  add_foreign_key "graduations", "doctors"
  add_foreign_key "graduations", "specialties"
